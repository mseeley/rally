...
(function (global) {
   ...
   *
   */
  function clear (callback, interval, scope) {
  ...
  global.timer = {
     ...
     * @return {Object} An object with a clear method for easy timer clearing
     * @static
     * @method set
     */
